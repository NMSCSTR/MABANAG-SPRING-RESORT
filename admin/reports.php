            ...
            <div class="content-area">
                ...
                <div class="row charts-row">
                    ...
                    <div class="col-xl-4 mb-4">
                        <div class="card chart-card">
                            ...
                            <div class="card-body">
                                <canvas id="bookingPieChart" height="300"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row charts-row">
                    ...
                    <div class="col-xl-6 mb-4">
                        <div class="card chart-card">
                            <div class="card-header">
                                <h5>Room vs Cottage Revenue</h5>
                            </div>
                            <div class="card-body">
                                <canvas id="typeComparisonChart" height="250"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="summary-card">
                            ...
                            <div class="summary-body">
                                <div class="summary-item">
                                    <span>Room Type</span>
                                    <strong id="topRoomType">-</strong>
                                </div>
                                <div class="summary-item">
                                    <span>Cottage Type</span>
                                    <strong id="topCottageType">-</strong>
                                </div>
                                <div class="summary-item">
                        ...
                        <div class="summary-card">
                            ...
                            <div class="summary-body">
                                <div class="summary-item">
                                    ...
                                    <strong id="peakHours">-</strong>
                                </div>
                                <div class="summary-item">
                                    <span>Avg. Stay Duration</span>
                                    <strong id="avgStay">-</strong>
                                </div>
                                <div class="summary-item">
                                    <span>Repeat Guests</span>
                                    <strong id="repeatGuests">-</strong>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="summary-card">
                            ...
                            <div class="summary-body">
                                ...
                                <div class="progress mb-2">
                                    <div class="progress-bar" id="monthlyTargetProgress" role="progressbar" style="width: 0%"></div>
                                </div>
                                <div class="summary-item">
                                ...
                                <div class="progress">
                                    <div class="progress-bar" id="occupancyGoalProgress" role="progressbar" style="width: 0%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
