                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                    <!-- Gcash Information -->
                                     ...
                                     ?>
                                    <div class="row g-3 align-items-center mb-3 border p-3 rounded bg-light">
                                    <div class="col-md-6">
                                        <label class="form-label text-danger fw-semibold">
                                        <i class="fas fa-mobile-alt me-2 text-primary"></i>Send payment to this Gcash #
                                        </label>
                                        <p class="mb-0 rounded px-3 py-2 bg-light">
                                        <?php echo $info['gcash_number'] ?>
                                        </p>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold">
                                        <i class="fas fa-user me-2 text-success"></i> Gcash Name
                                        </label>
                                        <p class="mb-0 rounded px-3 py-2 bg-light">
                                        <?php echo $info['gcash_name'] ?>
                                        </p>
                                    </div>
                                    </div>
                                    <hr>
